...
def find_percentiles(x):
	...
	return np.nanpercentile(y, 40), np.nanpercentile(y, 60), np.nanpercentile(y, 80)
...
print(ed25, ed50, ed75)
print(ne25, ne50, ne75)
print(tu25, tu50, tu75)
...
sitk.WriteImage(VOI_img, './VOI.nii.gz')